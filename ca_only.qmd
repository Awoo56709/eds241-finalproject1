...
# CA survey data
data_ca <- read.delim("https://dataverse.harvard.edu/api/access/datafile/10933509", header = TRUE) %>%
  [-c(1,2),] %>%  
  mutate(geo = "CA")

# CA distance-to-boundary file
dist_ca <- read.delim("https://dataverse.harvard.edu/api/access/datafile/10933516", header = TRUE)

# CA combined metadata
cw_ca <- read_csv("https://dataverse.harvard.edu/api/access/datafile/10933510")

# Lood zone file
fld_zone <- read.delim("https://dataverse.harvard.edu/api/access/datafile/10933526", header = TRUE)
